  ...
  <div class="content-wrapper">
    ...
    <section class="content center">
      ...
      <div class="box">
        ...
        <form role="form" name="myForm" onsubmit="return validateForm()" action="../reportsphp/softwarestat.php" method="POST">          
        <h3 class="box-title">Software Status</h3>
        </div>
        <div class="box-body">
