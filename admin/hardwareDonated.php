      ...
      <div class="box box-success">
        <div class="box-header with-border">
           ...
           <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"> Donated Hardware</li>
               <li class="dropdown">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            echo "Name</th><th>";
            echo "Location</th><th>";
            echo "Date Donated</th><th></th></thead><tbody>";
            ...
            if ($result->num_rows > 0)
            {
                ...
                {
                  echo "<tr><td>";
                  echo $row["dasset_id"]."</td><td>";
                  echo $row["name"]."</td><td>";
                  echo $row["location"]."</td><td>";
                  echo $row["dateRetired"]."</td><td></td></tr>";    
                }
            }
            echo "</tbody></table>";
            ?>
