      ...
      <div class="box box-success">
        <div class="box-header with-border">
           ...
           <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header">Undeployed Assets</li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li role="presentation"><a role="menuitem" tabindex="-1" href="assetsDeployed.php">Deployed Asset</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
        ...
        <div class="box-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            echo "Location</th><th>";
            echo "Supplier</th><th>";
            echo "Deploy Asset</th></thead><tbody>";
            ...
            if ($result->num_rows > 0)
            {
                while($row = $result->fetch_assoc()) 
                {
                  ...
                  ?><button type='button' class="btn btn-default" onClick="popitup2('deploy?hid=<?php echo $row['asset_id'];?>')" name='submit'><i class="fa fa-eye"></i> Deploy</button><?php
                  echo "</td></tr>";    
                }
            }
