          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            if ($result->num_rows > 0)
            {
                while($row = $result->fetch_assoc()) 
                {
                  ...
                  echo "</td><td>";
                ?>
                <button type="submit" class="btn btn-default" name="submit" onclick="return ConfirmDelete('serialDelete?id=<?php echo $row['software_id'];?>')" /><i class="fa fa-trash"></i> Uninstall</button></td></tr>
                <?php
                }
            }
            echo "</tbody></table>";
