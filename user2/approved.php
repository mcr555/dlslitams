      ...
      <div class="box box-success">
        ...
        <div class="box-body">
          ...
          <?php
            ...
            $sql = "SELECT *,ticket.ticket_type,ticket.date_requested,users.lastname,users.firstname FROM ticket_view LEFT JOIN ticket ON ticket.ticket_id=ticket_view.ticket_id LEFT JOIN users ON users.idnumber=ticket.user_id WHERE tistatus='1' AND tuser_id=$idnumber";  
