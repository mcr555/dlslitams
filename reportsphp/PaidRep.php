...
/////////////////////////////////////////////////////////////////////////export database to pdf format
	...
	mysql_select_db("hpbs", $con);
		 ...
		 $query = mysql_query("SELECT * FROM tblpatient1 WHERE Admissiondate >='$gen' AND Admissiondate <= '$gen1' AND Status = 'Paid' ");
		...
		$pdf->setX(120);$pdf->Cell(0,0,'Daily Reports- Paid ',0,0,'L');
		$pdf->Ln(10);
